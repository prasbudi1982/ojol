...
export function viewAdminSettings(settings, profile=null){
  ...
  <div class="admin-page">
    ...
    <div class="card">
      ...
      <label>Kecamatan Aktif - Pickup Area<select id="setKecamatan" style="width:100%;padding:10px;border-radius:8px;border:1px solid #334155;background:#0f172a;color:#e6edf5">${kecOptions}</select></label>
