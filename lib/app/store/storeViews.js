...
window._checkoutFoodDirect = async function(driverId){
  try{
    ...
    // HANYA SAAT CHECKOUT: kosongkan keranjang - AMAN (tidak crash jika cartStore tidak ada)
    ...
    try{ if(typeof cartStore!=='undefined' && cartStore && cartStore._actions && cartStore._actions.clearCart) cartStore._actions.clearCart(); }catch(e){}
