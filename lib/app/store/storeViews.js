...
export async function viewStoreCart(){
  let state;
  try{ state = cartStore.getState(); }catch(e){
  ...
  return `
    <div class="card">
      ...
      <div style="margin-top:12px;border-top:1px solid var(--border);padding-top:12px">
        <div class="muted" style="font-size:12px">Subtotal Rp ${totals.subtotal.toLocaleString()} • Ongkir Rp ${Number(totals.delivery_fee||0).toLocaleString()} (${totals.distance_km||0} km)</div>
