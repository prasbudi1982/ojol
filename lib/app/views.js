// views.js - FIX FINAL - toggle di bawah, tidak potong, tidak buka semua saat load
...
export function viewHome(p){
  ...
  <div id="discWrapper" data-collapsed="true" style="position:relative;max-height:110px;overflow:hidden;transition:max-height 0.35s ease">
    ...
    <div id="discFade" style="position:absolute;bottom:0;left:0;right:0;height:50px;background:linear-gradient(to bottom, rgba(0,0,0,0), rgba(15,23,42,0.95));pointer-events:none"></div>
  </div>
