...
export function viewPassenger(currentProfile){
  ...
  <label>Pickup <span class="muted" style="font-size:10px" id="pickupLive">📡 live (tap 📍 untuk update)</span>
    <div class="row" style="gap:8px;align-items:center"><input id="pickup" readonly placeholder="Tap 📍 untuk deteksi lokasi..." style="flex:4;min-width:0;background:var(--card2);cursor:default" title="Lokasi otomatis via GPS - tap 📍 untuk refresh"><button id="btnRefreshPickup" class="btn secondary" style="flex:0 0 48px;padding:8px 0">📍</button></div>
  </label>
  <label>Tujuan <span class="muted" style="font-size:10px" id="destLive">🗺️ pilih via Map</span>
    <div class="row" style="gap:8px;align-items:center"><input id="dest" readonly placeholder="Tap 🗺️ Map untuk pilih tujuan..." style="flex:4;min-width:0;background:var(--card2);cursor:default" title="Tujuan hanya via Map Picker - tap Map"><button id="btnOpenMap" class="btn secondary" style="flex:0 0 64px;padding:8px 0">🗺️ Map</button></div>
