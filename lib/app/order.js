...
// ===== AUTO FOCUS SCROLL FLOW - ALUR: Insert map -> fokus ke biaya =====
...
// 1. setelah map -> langsung biaya
export function onMapInserted(){ autoScrollTo('estimateCard', 250); }
export function onVehicleSelected(){ /* tidak dipakai di alur ini */ }
export function onTripTypeSelected(){ /* tidak dipakai */ }
export function onCostFocused(){ /* no auto */ }
...
(function(){
  ...
  // dest change HANYA jika ada flag map (justSelected) - cegah scroll dobel
})();

if(typeof window!=='undefined'){ window.autoScrollTo=autoScrollTo; window.onMapInserted=onMapInserted; window.initAutoFocusListeners=initAutoFocusListeners; }
