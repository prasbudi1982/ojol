...
// ===== AUTO FOCUS SCROLL FLOW - FIX: Map -> kendaraan -> driver (tanpa skip ke driver) =====
...
// 1. setelah map -> kendaraan
export function onMapInserted(){ autoScrollTo('vehicleSection', 200); }
// 2. setelah pilih kendaraan -> driver list (FIX BUG: sebelumnya ke tripType/biaya lalu langsung driver)
export function onVehicleSelected(){ autoScrollTo('driverList', 350); }
// fungsi lama tetap ada biar tidak breaking, tapi tidak auto scroll lagi
export function onTripTypeSelected(){ /* no auto scroll - alur baru langsung driver */ }
export function onCostFocused(){ /* disabled - cegah bug scroll langsung driver setelah map */ }
...
export function initAutoFocusListeners(){
  ...
  document.addEventListener('change', (e)=>{
    ...
    // tripType tidak trigger scroll lagi
  ...
  // HAPUS observer estimateCard yang bikin bug langsung ke driver setelah map
}
...
// ===== AUTO TRIGGER - FIX: hanya dari map, tidak dari ketik biasa =====
(function(){
  const tryInit = ()=> {
