// config.js - VERSI FLEKSIBEL STABIL FIXED
...
// Private key harus di server / Edge Function saja.
export const VAPID_PUBLIC_KEY = 'BPgR4-d50fIy5ceGjYenRq1StZ84Rz8_RZ46svhP8UZn0IKH0Y-roIuOMwBfxHjpeGGMUaFK6RrkdCmJ4oF0gPg';
// export const VAPID_PRIVATE_KEY = '... REMOVED FOR SECURITY ...';
...
export function hitungRincianTarif(distanceKm, vehicleType='motor', tripType='oneway'){
  ...
  return { base: t.base, perKm: t.perKm, distanceKm, tripCost: Math.round(tripCost), tripType, multiplier: tripType==='roundtrip'?TARIF.ppMultiplier:1, total, min: t.min };
}
