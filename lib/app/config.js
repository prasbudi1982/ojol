...
export const ACTIVE_KECAMATAN_CODE = '3503071'; // <-- GANTI KODE KECAMATAN DI SINI SAJA
...
export const APP_SETTINGS_DEFAULT = {
  ...
  disclaimerTitle: 'Layanan Ojol Lokal Trenggalek',
  disclaimerText: `Ojol Trenggalek adalah layanan transportasi lokal khusus wilayah Kabupaten Trenggalek. 
  Driver hanya bisa online di dalam kecamatan aktif (saat ini Suruh) dan tujuan hanya di dalam Trenggalek.
  Tarif dihitung otomatis berdasarkan jarak. Jaga keselamatan dan sopan santun.`,
