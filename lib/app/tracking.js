...
function renderActiveOrder(order, driver, opts={}){
  ...
  container.innerHTML = `
    <div style="border:1px solid var(--card2);border-radius:16px;overflow:hidden;background:var(--bg);box-shadow:0 20px 60px rgba(0,0,0,0.7)">
      ...
      ${routeHtml}
      ${bodyHtml}
      <div style="padding:10px;background:var(--bg);border-top:1px solid var(--card2);display:flex;gap:8px"><button id="btnCancelTracking" style="flex:1;background:var(--card2);color:#f87171;padding:11px;border-radius:10px;font-weight:600;border:1px solid var(--border);font-size:12px">❌ Batalkan Order</button><button id="btnCompleteOrder" style="flex:1;background:#16a34a;color:white;padding:11px;border-radius:10px;font-weight:700;border:none;font-size:12px">✅ Selesai</button></div>
    </div>`;
