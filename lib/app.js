...
async function render(){
  ...
  const navPass=document.querySelector('a[href="#/passenger"]'); const navDriver=document.querySelector('a[href="#/driver"]'); const navAdminChk=document.querySelector('a[href="#/admin"]');
  if(currentProfile){
    if(currentProfile.role==='admin'){ if(navPass) navPass.style.display='none'; if(navDriver) navDriver.style.display='none'; if(navAdminChk) navAdminChk.style.display=''; if(hash.startsWith('#/passenger')||hash.startsWith('#/driver')){ location.hash='#/admin'; return; } }
    else if(currentProfile.role==='driver'){ if(navPass) navPass.style.display='none'; if(navDriver) navDriver.style.display=''; if(navAdminChk) navAdminChk.style.display='none'; if(hash.startsWith('#/passenger')||hash.startsWith('#/admin')){ location.hash='#/'; return; } }
    else { if(navDriver) navDriver.style.display='none'; if(navPass) navPass.style.display=''; if(navAdminChk) navAdminChk.style.display='none'; if(hash.startsWith('#/driver')||hash.startsWith('#/admin')){ location.hash='#/'; return; } }
